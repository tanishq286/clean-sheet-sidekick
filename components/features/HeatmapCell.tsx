...
export function HeatmapCell({ cell, mode, teamName, muted, delay }: HeatmapCellProps) {
  if (cell.blank) {
    return (
      <div className="flex h-16 w-[88px] shrink-0 items-center justify-center border-b border-l border-black/[0.06]">
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <motion.div
          ...
          className="group relative flex h-16 w-[88px] shrink-0 cursor-default flex-col items-center justify-center gap-0.5 border-b border-l border-black/[0.06]"
          style={{
        ...
        >
          ...
          <span className="flex items-center gap-1 text-[10px] font-semibold text-black/60">
